...
const SkeletonTwo = () => {
    ...
    // FIX: Using static widths instead of Math.random() to prevent hydration error
    const staticWidths = ["85%", "45%", "95%", "70%", "90%", "55%"];
        ...
        >
            {arr.map((_, i) => (
                <motion.div
                    ...
                    variants={variants}
                    style={{
                        maxWidth: staticWidths[i % staticWidths.length],
                    }}
